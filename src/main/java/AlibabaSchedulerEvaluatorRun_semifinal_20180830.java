 ...
 */
public class AlibabaSchedulerEvaluatorRun_semifinal_20180830 {
    // 参数
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 6) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                BufferedReader bs = new BufferedReader(new FileReader(new File(path+args[i])));
            ...
            resultIS = new FileInputStream(path+args[5]);
        }
        else {
            problemIS = new FileInputStream(path+args[0]);
            resultIS = new FileInputStream(path+args[1]);
        }
        
        // 评测
        AlibabaSchedulerEvaluatorRun_semifinal_20180830 evaluator = new AlibabaSchedulerEvaluatorRun_semifinal_20180830();
        evaluator.init(new BufferedReader(new InputStreamReader(problemIS)));
        double score = evaluator.evaluate(new BufferedReader(new InputStreamReader(resultIS)));
