...
public class AlibabaSchedulerEvaluatorRun {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 5) {
            ...
            result = new FileInputStream(path+args[4]);
        }
        else {
        ...
        evaluator.init(new BufferedReader(new InputStreamReader(problem)));
        double score = evaluator.evaluate(new BufferedReader(new InputStreamReader(result)));
